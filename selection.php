...
<body class="bg-white text-gray-800 overflow-x-hidden">
  ...
  <section class="py-16 max-w-8xl mx-auto bg-gradient-to-b from-white to-red-300">
    ...
    <div class="flex flex-col justify-center items-center">
      <h2 class="text-4xl text-purple-600 satisfy-regular text-center mt-8 mb-4">Our Selections</h2>
      <h2 class="text-xl max-w-2xl zilla-slab-regular text-center mb-6">✨“ Our achievers prove that exams may end in
        results, but true learning builds leaders, dreamers, and changemakers for life. ”✨</h2>
    </div>

    <!-- SELECTION GRID: 3 ROWS x 3 COLUMNS, Responsive, New Card Style -->
    <div id="candidates-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 px-6">
  ...
  <section class="flex flex-col lg:flex-row py-12 max-w-7xl mx-auto px-4 curriculum-section">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center gap-8">
      <h2 class="text-4xl satisfy-regular mb-8">Structure driven Curriculum</h2>
